...
SELECT
	...
	'' AS pm_ignore_list, user_newpm AS unread_messages,
...
SELECT fn_id AS id_cat, SUBSTRING(fn_title, 1, 255) AS name, fn_path AS cat_order
FROM {$from_prefix}forum_structure;
---*
