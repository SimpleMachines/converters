...
function convert_query($string, $return_error = false)
{
	...
	global $db_connection;
		...
		$db_errno = $smcFunc['db_title'] == 'MySQL' ? mysqli_errno($db_connection) : ($smcFunc['db_title'] == 'SQLite' ? sqlite_last_error() : ($smcFunc['db_title'] == 'PostgreSQL' ? pg_last_error() : $smcFunc['db_error']($db_connection)));
