...
class smf20_to_smf extends ConverterBase
{
	...
	{
		global $db_server, $db_name, $db_user, $db_passwd, $db_prefix, $protection;

		// Protect these as SMF also uses them.
		foreach (['db_server', 'db_name', 'db_user', 'db_passwd', 'db_prefix'] as $v)
	...
	public static string	$convertStep35info = 'Converting permission profiles';
